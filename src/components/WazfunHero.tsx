...
export function WazfunHero() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-wazfun-teal via-wazfun-teal-dark to-wazfun-teal flex items-center justify-center overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-40 h-40 bg-white/10 rounded-full animate-pulse"></div>
        <div className="absolute top-40 right-32 w-32 h-32 bg-wazfun-yellow/20 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-32 left-1/4 w-28 h-28 bg-wazfun-mint/15 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
        ...
        >
          ...
          >
            <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full">
              <Sparkles className="w-8 h-8 text-wazfun-yellow" />
          ...
          >
            ...
            <br />
            <span className="text-wazfun-yellow">Bisa Dapetin Hadiah Ini!</span>
          </motion.h1>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-wazfun-yellow text-wazfun-navy px-8 py-4 rounded-full font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-3"
              style={{ fontFamily: 'Poppins, sans-serif' }}
            >
